...
class GiftCardQueries(graphene.ObjectType):
    ...
    gift_cards = FilterInputConnectionField(
        GiftCard,
        sort_by=GiftCardSortingInput(description="{ADDED_IN_31} Sort gift cards."),
        filter=GiftCardFilterInput(description="{ADDED_IN_31} Filtering options for gift cards."),
